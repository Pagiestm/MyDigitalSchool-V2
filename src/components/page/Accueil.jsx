            ...
            <section className="text-gray-600 body-font">
                <div className="mx-auto lg:px-8 lg:px-20 flex flex-wrap lg:flex-nowrap">
                    <div className="flex flex-wrap mt-auto mb-auto w-full content-start order-2 lg:order-first lg:mb-8">
                        ...
                        <StatCard number="95%" text="De taux d’insertion post diplôme" />
                        <StatCard number="2200" text="Entreprises partenaires" />
                        <StatCard number="15" text="Certifications professionnelles" />
                        <StatCard number="22" text="Labels et accréditations" />
                    </div>
            ...
            <section class="text-gray-600 body-font">
                ...
                <div class="container px-5 mx-auto flex flex-wrap">
                    <div class="flex flex-wrap -m-4">
                        <FormationCard title="Bachelor web design" description="Le Bachelor développeur web MyDigitalSchool permet un début de spécialisation dans les métiers du développement web. Après deux premières années de socle commun, les étudiants abordent de manière..." />
                        <FormationCard title="Bachelor web design" description="Le Bachelor développeur web MyDigitalSchool permet un début de spécialisation dans les métiers du développement web. Après deux premières années de socle commun, les étudiants abordent de manière..." />
                        <FormationCard title="Bachelor webmarketing" description="Le Bachelor développeur web MyDigitalSchool permet un début de spécialisation dans les métiers du développement web. Après deux premières années de socle commun, les étudiants abordent de manière..." />
                        <FormationCard title="Bachelor digital" description="Le Bachelor développeur web MyDigitalSchool permet un début de spécialisation dans les métiers du développement web. Après deux premières années de socle commun, les étudiants abordent de manière..." />
                    </div>
                </div>
            </section>
        </>
