...
import IconFacebook from "../../assets/icons/facebook-white.svg";
import IconTwitter from "../../assets/icons/twitter-white.svg";
import IconLinkedin from "../../assets/icons/linkedin-white.svg";
    ...
    return (
        <main className="md:px-44 my-4">
            <div className="flex flex-col items-center">
                ...
                <p className="mt-4 md:px-0 px-5 w-2/3 text-center">Nos intervenants sont tous des professionnels experts
                    de la filière, le mode projet et le travail collaboratif sont au cœur de la pédagogie, et les stages
                    et l’alternance occupent une place de choix.</p>
            </div>
